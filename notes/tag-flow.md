...
- Archivo: `.devtools/bin/git-promote.sh`.
...
- Archivo: `.devtools/lib/promote/version-strategy.sh`.
...
## Semver y arranque
- Archivo: `.devtools/lib/core/semver.sh`.
...
- DEV: `.devtools/lib/promote/workflows/to-dev.sh` usa rango `origin/staging..source_sha` para `promote_next_tag_dev`.
- STAGING: `.devtools/lib/promote/workflows/to-staging.sh` usa rango `origin/staging..dev` para `promote_next_tag_staging`.
- PROD: `.devtools/lib/promote/workflows/to-prod.sh` usa `promote_next_tag_prod` (sin rango).

## Persistencia de .promote_tag (almacen temporal)
- Ruta: `.devtools/lib/promote/version-strategy.sh` -> `promote_tag_file_path`.
- Lectura: `promote_last_tag_or_empty` (version-strategy).
- Escritura en DEV: `.devtools/lib/promote/workflows/to-dev.sh`.
- Lectura y re-escritura en STAGING: `.devtools/lib/promote/workflows/to-staging.sh`.
- Lectura y re-escritura en PROD: `.devtools/lib/promote/workflows/to-prod.sh`.
- Lectura en HOTFIX: `.devtools/lib/promote/workflows/hotfix.sh`.

## Notas de lanzamiento (.md)
- STAGING: `.devtools/releases/staging.md` generado en `to-staging.sh`.
- PROD: `.devtools/releases/prod.md` generado en `to-prod.sh`.
- HOTFIX: `.devtools/releases/hotfix.md` generado en `hotfix.sh`.
- Helpers: `capture_release_notes` y `prepend_release_notes_header` en `.devtools/lib/release-flow.sh`.

## Creacion de tags y lanzamientos en GitHub
- Archivo: `.devtools/lib/promote/helpers/gh-interactions.sh`.
...
- Archivo: `.devtools/lib/promote/workflows/common.sh`.
